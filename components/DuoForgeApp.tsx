...
function CompanionBody({speaker,mood,talking}:{speaker:Speaker;mood:Mood;talking:boolean}){
  const src=speaker==='Myria'?BASE_PATH+'/companions/myria.png':BASE_PATH+'/companions/jasper.png';
  return <figure className={styles.bodyAvatar} data-speaker={speaker} data-mood={mood} data-talking={talking}>
    <div className={styles.liveRig}>
      <div className={styles.rigAura}/>
      <img className={styles.rigImage} src={src} alt={speaker+' animated 2D companion'} draggable={false}/>
      <div className={styles.rigBlink}/>
      <div className={styles.rigSpeechPulse}/>
    </div>
